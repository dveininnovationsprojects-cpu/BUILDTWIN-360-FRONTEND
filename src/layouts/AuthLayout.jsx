...
export function AuthLayout() {
  return (
    <>
      <div className="auth-scene auth-default-scene relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-8 sm:px-6">
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="auth-glass auth-default-glass rounded-2xl p-6 sm:p-8">
