...
import { Card, CardHeader, CardTitle, StatusPill, Button, Modal, Input, Select } from '@/design-system';
import { BUILDTWIN_KPI_DICTIONARY } from '../constants/kpiDictionaryData';
import type { KPIDefinition } from '../types';
import { Search, Info, CheckCircle2, ShieldAlert, Cpu, BookOpen, Layers } from 'lucide-react';
